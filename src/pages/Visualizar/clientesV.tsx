            ...
            <main>
                ...
                <Card bg="white" text="dark" style={{ width: '18rem' }} className="mb-2">
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>Nome Social: Dika</Card.Text>
                            <Card.Text>Gênero: Feminino</Card.Text>
                            <Card.Text>CPF: 111.111.11-11</Card.Text>
                            <Card.Text>RG: 11.11.111/1</Card.Text>
                            <Card.Text>Telefone: 12 3911-1111</Card.Text>
                            <Card.Text>Telefone: 12 99211-1111</Card.Text>
                        </Card.Body>
                    </Card>
                </div>
            </main>
